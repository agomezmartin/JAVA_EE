...
<script type="text/javascript">
	function mostrarLibros(){
		var dir="Controller";
		$.get(dir,{"option":"doLibros","idTema":$("#idTema").val()},function(data,status){
	...
	function agregarCarrito(isbn){
		var dir="Controller";
		$.get(dir,{"option":"doAgregar","isbn":isbn},function(data,status){
			var tabla="<table border='1'><tr><th></th><th>Titulo</th><th>Autor</th><th>Precio</th></tr>";
			var pos=0;
			for(var c of data){
	...
	function eliminarCarrito(pos){
		var dir="Controller";
		$.get(dir,{"option":"doEliminar","posicion":pos},function(data,status){
			var tabla="<table border='1'><tr><th></th><th>Titulo</th><th>Autor</th><th>Precio</th></tr>";
			var pos=0;
			for(var c of data){
				tabla+="<tr><td><a href='#' onclick='eliminarCarrito("+pos+")'>Eliminar</a></td><td>"+c.titulo+"</td><td>"+c.autor+"</td><td>"+c.precio+"</td></tr>";
