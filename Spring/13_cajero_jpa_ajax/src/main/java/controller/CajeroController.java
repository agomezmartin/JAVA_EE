...
public class CajeroController {
	...
	@GetMapping(value="movimientosSaldo",produces=MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody List<Movimiento> saldoMovimiento(@SessionAttribute("idCuenta") int idCuenta) {
		return service.consultarMovimientos(idCuenta);
	}
